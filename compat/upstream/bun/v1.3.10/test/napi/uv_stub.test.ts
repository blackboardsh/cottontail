...
import { symbols, test_skipped } from "../../../../../../src/compiler/src/jsc/bindings/libuv/generate_uv_posix_stubs_constants.ts";
...
`,
    ...
    const libuvDir = path.join(__dirname, "../../../../../../src/compiler/src/jsc/bindings/libuv");
