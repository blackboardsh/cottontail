...
import {
  deserializeJscValue,
  jscValueSerializationFormatVersion,
  serializeJscValue,
} from "../internal/jsc-value-serialization.js";

const formatVersion = jscValueSerializationFormatVersion;
let flags = "";
...
function payloadBuffer(value, options = undefined) {
  return Buffer.from(serializeJscValue(value, options));
}

function parsePayload(buffer) {
  return deserializeJscValue(buffer);
}
