// Vendored from readable-stream@4.7.0 (https://github.com/nodejs/readable-stream)
...
var require_buffer = __commonJS({
  "ct-shim:buffer"(exports, module) {
    module.exports = { Buffer: __ct_Buffer, Blob: __ct_Blob };
  }
});

// package/lib/ours/primordials.js
var require_primordials = __commonJS({
  "package/lib/ours/primordials.js"(exports, module) {
    "use strict";
...
// package/lib/ours/util/inspect.js
var require_inspect = __commonJS({
  "package/lib/ours/util/inspect.js"(exports, module) {
    "use strict";
    module.exports = {
      format(format, ...args) {
...
// package/lib/ours/errors.js
var require_errors = __commonJS({
  "package/lib/ours/errors.js"(exports, module) {
    "use strict";
...
// ct-shim:abort-controller
var require_abort_controller = __commonJS({
  "ct-shim:abort-controller"(exports, module) {
    ...
    var AbortSignalShim = {
      get any() {
        ...
        return ctor && ctor.any ? ctor.any.bind(ctor) : void 0;
      },
      get abort() {
        const ctor = globalThis.AbortSignal;
        return ctor && ctor.abort ? ctor.abort.bind(ctor) : void 0;
      },
      get timeout() {
        const ctor = globalThis.AbortSignal;
        return ctor && ctor.timeout ? ctor.timeout.bind(ctor) : void 0;
      }
    };
...
var require_events = __commonJS({
  "ct-shim:events"(exports, module) {
    ...
    var base = __ct_EventEmitter.prototype;
    EventEmitter.prototype.removeListener = function removeListener(name, handler) {
      const hadListener = this._events instanceof Map && (this._events.get(name) || []).some((item) => item === handler || item.listener === handler);
    ...
    EventEmitter.prototype.emit = function emit(name, ...args) {
      ...
      for (const handler of handlers) {
        ...
        if (this.captureRejections && result && typeof result.then === "function") {
          result.then(void 0, (error) => this.emit("error", error));
        }
      }
...
// package/lib/ours/util.js
var require_util = __commonJS({
  "package/lib/ours/util.js"(exports, module) {
    "use strict";
...
// package/lib/internal/validators.js
var require_validators = __commonJS({
  "package/lib/internal/validators.js"(exports, module) {
    "use strict";
    var {
      ArrayIsArray,
...
var require_process = __commonJS({
  "ct-shim:process/"(exports, module) {
    var p = globalThis.process;
    if (!p) {
      p = { env: {}, nextTick: function(cb) {
...
// package/lib/internal/streams/utils.js
var require_utils = __commonJS({
  "package/lib/internal/streams/utils.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/end-of-stream.js
var require_end_of_stream = __commonJS({
  "package/lib/internal/streams/end-of-stream.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/destroy.js
var require_destroy = __commonJS({
  "package/lib/internal/streams/destroy.js"(exports, module) {
    "use strict";
    var process = require_process();
    var {
      aggregateTwoErrors,
...
// package/lib/internal/streams/legacy.js
var require_legacy = __commonJS({
  "package/lib/internal/streams/legacy.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/add-abort-signal.js
var require_add_abort_signal = __commonJS({
  "package/lib/internal/streams/add-abort-signal.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/buffer_list.js
var require_buffer_list = __commonJS({
  "package/lib/internal/streams/buffer_list.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/state.js
var require_state = __commonJS({
  "package/lib/internal/streams/state.js"(exports, module) {
    "use strict";
...
// ct-shim:string_decoder/
var require_string_decoder = __commonJS({
  "ct-shim:string_decoder/"(exports, module) {
    module.exports = { StringDecoder: __ct_StringDecoder };
  }
});

// package/lib/internal/streams/from.js
var require_from = __commonJS({
  "package/lib/internal/streams/from.js"(exports, module) {
    "use strict";
    var process = require_process();
...
// package/lib/internal/streams/readable.js
var require_readable = __commonJS({
  "package/lib/internal/streams/readable.js"(exports, module) {
    "use strict";
    var process = require_process();
    var {
    ...
    function Readable(options) {
      ...
      if (this._read === Readable.prototype._read && (this.resume !== Readable.prototype.resume || this.pause !== Readable.prototype.pause)) {
    ...
    async function* createAsyncIterator(stream, options) {
      ...
      try {
        while (true) {
          const chunk = (stream._readableState ? stream._readableState.destroyed : stream.destroyed) ? null : stream.read();
          if (chunk !== null) {
            yield chunk;
          } else if (error) {
            throw error;
...
// package/lib/internal/streams/writable.js
var require_writable = __commonJS({
  "package/lib/internal/streams/writable.js"(exports, module) {
    "use strict";
    var process = require_process();
    var {
      ArrayPrototypeSlice,
...
// package/lib/internal/streams/duplexify.js
var require_duplexify = __commonJS({
  "package/lib/internal/streams/duplexify.js"(exports, module) {
    var process = require_process();
    var bufferModule = require_buffer();
    var {
      isReadable,
...
// package/lib/internal/streams/duplex.js
var require_duplex = __commonJS({
  "package/lib/internal/streams/duplex.js"(exports, module) {
    "use strict";
    var {
      ObjectDefineProperties,
...
// package/lib/internal/streams/transform.js
var require_transform = __commonJS({
  "package/lib/internal/streams/transform.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/passthrough.js
var require_passthrough = __commonJS({
  "package/lib/internal/streams/passthrough.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/pipeline.js
var require_pipeline = __commonJS({
  "package/lib/internal/streams/pipeline.js"(exports, module) {
    var process = require_process();
...
// package/lib/internal/streams/compose.js
var require_compose = __commonJS({
  "package/lib/internal/streams/compose.js"(exports, module) {
    "use strict";
...
// package/lib/internal/streams/operators.js
var require_operators = __commonJS({
  "package/lib/internal/streams/operators.js"(exports, module) {
    "use strict";
    var AbortController = globalThis.AbortController || require_abort_controller().AbortController;
    var {
...
// package/lib/stream/promises.js
var require_promises = __commonJS({
  "package/lib/stream/promises.js"(exports, module) {
    "use strict";
...
var require_stream = __commonJS({
  "package/lib/stream.js"(exports, module) {
    "use strict";
    var { Buffer: Buffer2 } = require_buffer();
...
var ct_entry_default = import_stream.default;
export {
  ct_entry_default as default
};
