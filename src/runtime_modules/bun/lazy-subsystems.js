...
export const loadJSON5Module = createLazyModule("bun:json5", () => loadEmbeddedRuntimeModule("bun/json5.js"));
export const JSON5 = createLazyObject(loadJSON5Module, "JSON5");

export const loadTOMLModule = createLazyModule("bun:toml", () => loadEmbeddedRuntimeModule("bun/toml.js"));
export const TOML = createLazyObject(loadTOMLModule, "TOML");

export const loadYAMLModule = createLazyModule("bun:yaml", () => loadEmbeddedRuntimeModule("bun/yaml.js"));
...
export const loadS3Module = createLazyModule("bun:s3", () => loadEmbeddedRuntimeModule("bun/s3.js"));
export const S3Client = createLazyFunction(loadS3Module, "S3Client");
export const s3 = createLazyObject(loadS3Module, "s3");

export const loadRedisModule = createLazyModule("bun:redis", () => loadEmbeddedRuntimeModule("bun/redis.js"));
...
export const loadSQLModule = createLazyModule("bun:sql", () => loadEmbeddedRuntimeModule("bun/sql.js"));
export const SQL = createLazyFunction(loadSQLModule, "SQL");
export const sql = createLazyFunction(loadSQLModule, "sql");
export const postgres = sql;

export const loadColorModule = createLazyModule("bun:color", () => loadEmbeddedRuntimeModule("bun/color.js"));
...
export const loadBunTestModule = createLazyModule("bun:test", () => loadEmbeddedRuntimeModule("bun/test.js"));
export const bunTestBuiltin = createLazyBuiltin(
  loadBunTestModule,
  module => module.default ?? module,
);

export const loadBunJSCModule = createLazyModule("bun:jsc", () => loadEmbeddedRuntimeModule("bun/jsc.js"));
export const bunJSCBuiltin = createLazyBuiltin(
  loadBunJSCModule,
  module => module.default ?? module,
);

export const loadBunSQLiteModule = createLazyModule("bun:sqlite", () => loadEmbeddedRuntimeModule("bun/sqlite.js"));
export const bunSQLiteBuiltin = createLazyBuiltin(loadBunSQLiteModule);

export const loadWebSocketModule = createLazyModule(
  "vendor:ws",
  () => loadEmbeddedRuntimeModule("vendor/ws.js"),
);
