...
import * as FFI from "./ffi-capability.js";
import * as JSCCapability from "./jsc-capability.js";
import SQLiteDefault, {
  Database as SQLiteDatabase,
  SQLiteError as SQLiteErrorConstructor,
  Statement as SQLiteStatement,
  constants as SQLiteConstants,
} from "./sqlite-capability.js";
...
import * as NodeZlibCapability from "../node/zlib-capability.js";
...
// A callable default export makes the runtime bundler's `import *` interop
// collapse bun:sqlite to that function. Keep an explicit namespace object so
// ESM named imports, CommonJS require, and Cottontail.bun.sqlite share the
// same lazy facade values without activating SQLite.
const SQLiteCapability = {
  default: SQLiteDefault,
...
registerEmbeddedRuntimeModules({
  ...
  "bun/ffi-capability.js": FFI,
  "bun/jsc-capability.js": JSCCapability,
  "bun/sqlite-capability.js": SQLiteCapability,
  ...
  "node/zlib-capability.js": NodeZlibCapability,
  "vendor/whatwg-url.js": WhatwgUrlNamespace,
});

// These compatibility aliases expose the canonical lazy facade so ESM,
// CommonJS, and Cottontail.* all share the same wrapper identities.
Object.defineProperty(globalThis.Cottontail.node, "zlib", {
  configurable: true,
  get() {
    const value = NodeZlibCapability.default ?? NodeZlibCapability;
    Object.defineProperty(globalThis.Cottontail.node, "zlib", { value, configurable: true });
    return value;
  },
});
Object.defineProperty(globalThis.Cottontail.bun, "jsc", {
  configurable: true,
  get() {
    const value = JSCCapability.default ?? JSCCapability;
    Object.defineProperty(globalThis.Cottontail.bun, "jsc", { value, configurable: true });
    return value;
  },
});

const loadPasswordModule = createLazyModule("Cottontail.password", () =>
  loadCottontailCapabilityModule("password", "bun/password.js")
);
...
const loadNodeZlibModule = createLazyModule("node:zlib", () => loadCottontailCapabilityModule("compression", "node/zlib.js"));
const loadTextModule = createLazyModule("bun:text", () => loadCottontailCapabilityModule("text", "bun/text.js"));
const loadUuidModule = createLazyModule("bun:uuid", () => loadCottontailCapabilityModule("uuid", "bun/uuid.js"));
...
const loadBunShellModule = createLazyModule("bun:shell", () => {
  const { createBunShellFacade } = loadCottontailCapabilityModule("shell", "bun/shell.js");
...
const loadBunBuildModule = createLazyModule("bun:build", () => {
  const { createBunBuildFacade } = loadCottontailCapabilityModule("build", "bun/build.js");
...
const loadArchiveModule = createLazyModule("Cottontail.archive", () => loadCottontailCapabilityModule("archive", "bun/archive.js"));
export const Archive = createLazyFunction(loadArchiveModule, "Archive");
...
const loadHashingModule = createLazyModule("Cottontail.hashing", () =>
  loadCottontailCapabilityModule("hashing", "bun/hashing.js")
);
export const CryptoHasher = createLazyFunction(loadHashingModule, "CryptoHasher");
export const MD4 = createLazyFunction(loadHashingModule, "MD4");
export const MD5 = createLazyFunction(loadHashingModule, "MD5");
export const SHA1 = createLazyFunction(loadHashingModule, "SHA1");
export const SHA224 = createLazyFunction(loadHashingModule, "SHA224");
export const SHA256 = createLazyFunction(loadHashingModule, "SHA256");
export const SHA384 = createLazyFunction(loadHashingModule, "SHA384");
export const SHA512 = createLazyFunction(loadHashingModule, "SHA512");
export const SHA512_256 = createLazyFunction(loadHashingModule, "SHA512_256");
...
export const escapeHTML = createLazyFunction(loadTextModule, "escapeHTML");
export const stripANSI = createLazyFunction(loadTextModule, "stripANSI");
export const stringWidth = createLazyFunction(loadTextModule, "stringWidth");
export const wrapAnsi = createLazyFunction(loadTextModule, "wrapAnsi");

function legacyWrapAnsi(value, columns = 80, options = {}) {
...
export const hash = createLazyFunction(loadHashingModule, "hash");

export const randomUUIDv7 = createLazyFunction(loadUuidModule, "randomUUIDv7");
export const randomUUIDv5 = createLazyFunction(loadUuidModule, "randomUUIDv5");
...
const loadDataModule = createLazyModule("Cottontail.data", () =>
  loadCottontailCapabilityModule("data", "bun/data.js")
);
export const JSONC = createLazyObject(loadDataModule, "JSONC");
export const JSONL = createLazyObject(loadDataModule, "JSONL");
let cookieRuntime;
const loadCookieRuntime = () => cookieRuntime ??= loadCottontailCapabilityModule("cookies", "bun/cookie.js").createCookieRuntime(nodeInspect);
export const Cookie = createLazyFunction(loadCookieRuntime, "Cookie");
export const CookieMap = createLazyFunction(loadCookieRuntime, "CookieMap");
const loadGlobModule = createLazyModule("bun:glob", () => loadCottontailCapabilityModule("glob", "bun/glob.js"));
export const Glob = createLazyFunction(loadGlobModule, "Glob");
...
const loadHtmlRewriterModule = createLazyModule("Cottontail.htmlRewriter", () => loadCottontailCapabilityModule("html-rewriter", "bun/html-rewriter.js"));
export const HTMLRewriter = createLazyFunction(loadHtmlRewriterModule, "HTMLRewriter");
...
export const password = createLazyObject(() => ({ password: loadPasswordModule().password }), "password");
...
const loadMarkdownModule = createLazyModule("Cottontail.markdown", () =>
  loadCottontailCapabilityModule("markdown", "bun/markdown.js")
);
export const markdown = createLazyObject(loadMarkdownModule, "markdown");
...
const loadCsrfModule = createLazyModule("Cottontail.csrf", () => loadCottontailCapabilityModule("csrf", "bun/csrf.js"));
export const CSRF = createLazyObject(loadCsrfModule, "CSRF");
let BunFile;
...
nodeSetBuiltinModules({
  ...
  "bun:jsc": JSCCapability,
  // CommonJS and ESM aliases converge on the same Cottontail capability
  // getter and therefore the same bytecode/module cache entry.
  "bun:ffi": FFI,
  "bun:sqlite": SQLiteCapability,
