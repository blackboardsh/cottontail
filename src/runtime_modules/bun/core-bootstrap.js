...
function installProcessApi(processObject) {
  // Capability bytecode may contain modules such as node:fs which import this
  // bootstrap for its foundational globals. Those modules execute in the
  // capability program and must not replace methods on the already-initialized
  // host process object with functions closed over the capability program.
  const installedKey = Symbol.for("cottontail.coreProcessApiInstalled");
  if (processObject[installedKey] === true) return;
  Object.defineProperty(processObject, installedKey, {
    value: true,
    configurable: false,
  });
...
if (globalThis.__cottontailStandaloneFlags &&
    globalThis.__cottontailHutchPrivateFileMode == null &&
    Array.isArray(g.process.argv) && g.process.argv.length > 0) {
...
const workerRuntimeAliasPaths = Object.freeze({
  ...
  zlib: "node/zlib.js",
  bun: "bun/index.js",
  "bun:ffi": "bun/ffi-capability.js",
  "bun:jsc": "bun/jsc-capability.js",
  "bun:sqlite": "bun/sqlite-capability.js",
  "bun:test": "bun/test-capability.js",
  ...
  ws: "vendor/ws-capability.js",
  "ws/lib/websocket": "vendor/ws-capability.js",
  "next/dist/compiled/ws": "vendor/ws-capability.js",
  sea: "node/sea.js",
  sqlite: "node/sqlite-capability.js",
  test: "node/test-capability.js",
  "test/reporters": "node/test-reporters-capability.js",
});
