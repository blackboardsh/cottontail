...
pub fn TagTypeEnumWithTypeMap(comptime Types: anytype) struct {
    ...
    var enumNames: [Types.len][]const u8 = undefined;
    var enumValues: [Types.len]TaggedPointer.Tag = undefined;
    ...
    return .{
        .tag_type = @Enum(TaggedPointer.Tag, .nonexhaustive, &enumNames, &enumValues),
        .ty_map = typeMap,
    };
}
