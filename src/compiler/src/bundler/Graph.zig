...
html_imports: struct {
    ...
    server_source_indices: BabyList(Index.Int) = .empty,
    /// Source index of the HTML file being imported
    html_source_indices: BabyList(Index.Int) = .empty,
} = .{},
...
pub const InputFile = struct {
    ...
    additional_files: BabyList(AdditionalFile) = .empty,
