...
assert(parse("https://google.com?q=%A710", false, true).host === "google.com", "legacy url malformed escape host mismatch");
assert(parse("https://google.com'.bb.com/1.html", false, true).host === "google.com", "legacy url hostname terminator mismatch");
assert(parse("/foo/bar", false, true).pathname === "/foo/bar", "legacy url relative pathname mismatch");
